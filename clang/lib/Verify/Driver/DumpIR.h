...
/// Parse `--dump-ir` value: empty / "all" → all layers; "1,2,3,4" or "layer-1,...".
...
void dumpPassiveProgram(llvm::StringRef FnName, const PassiveProgram &P,
                        llvm::raw_ostream &OS);
void dumpVC(llvm::StringRef FnName, const VExpr *VC, llvm::raw_ostream &OS);
void dumpZ3(const VExpr *VC, llvm::raw_ostream &OS);
